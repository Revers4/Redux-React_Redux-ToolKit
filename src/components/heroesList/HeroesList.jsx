...
import { heroesFetching, heroesFetched, heroesFetchingError, heroesDelete } from '../../actions/actions';
...
const HeroesList = (props) => {
    const filtreredHeroes = useSelector(state => state.filtreredHeroes)
